  ...
  return (
    <div className={isDark ? "min-h-screen flex items-center justify-center bg-gradient-to-br from-[#181C23] via-[#23272f] to-[#1a2332]" : "min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-blue-50 to-blue-200"}>
      <div className={isDark ? "max-w-lg w-full bg-[#23272f]/80 rounded-3xl shadow-2xl p-10 flex flex-col items-center backdrop-blur-lg relative" : "max-w-lg w-full bg-white rounded-3xl shadow-2xl p-10 flex flex-col items-center relative"}>
        ...
        <img src="/WhatsApp Image 2025-09-11 at 02.43.41_bd8ddeec.jpg" alt="Grammoz Logo" className="h-20 w-20 mb-2 rounded-xl shadow-lg border-2 border-blue-900" />
        <span className={isDark ? "text-2xl font-bold text-blue-200 mb-4" : "text-2xl font-bold text-blue-700 mb-4"}>GraMoz</span>
        <h1 className={isDark ? "text-3xl font-extrabold mb-6 text-white text-center" : "text-3xl font-extrabold mb-6 text-blue-900 text-center"}>Create your account</h1>
        <div className="w-full">
          <div className="mb-4">
            <label className="block text-base font-medium mb-2 text-blue-200">Name</label>
            <input type="text" className={isDark ? "w-full border border-blue-900 rounded-lg px-4 py-3 text-base bg-[#181C23] text-white focus:outline-none focus:ring-2 focus:ring-blue-400" : "w-full border border-blue-300 rounded-lg px-4 py-3 text-base bg-blue-50 text-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-400"} placeholder="Enter your name" value={name} onChange={e => setName(e.target.value)} />
          </div>
          <div className="mb-4">
          ...
          <div className="flex items-center mb-6">
            ...
            <span className="text-blue-200">I agree to the <a href="#" className="underline text-blue-400">terms & policy</a></span>
          </div>
          <button className="w-full py-3 bg-blue-700 text-white rounded-lg font-semibold text-base hover:bg-blue-900 transition mb-6" onClick={handleSignup}>Signup</button>
          ...
          <div className="text-center text-base mt-4 text-blue-200">
            Have an account? <button className="text-blue-400 underline" onClick={() => navigate("/login")}>Sign In</button>
          </div>
        </div>
      </div>
    </div>
